...
\end{frame}
% XXX Get original images of underlines
% XXX Also Daniel vs. Noah Webster, and changing words
...
% XXX get a better, non-Canadian picture, like the supreme court building
...
% XXX include Friedman v. Goodwin, and perhaps something else showing the way things should be
...
% XXX Include stained glass window
% XXX also include pictures of nationalists and states rights people, to highlight Lincoln
...
% XXX Dealn wilson  is hte first on the left side. Greg Hagwood is in the middle, right next to some lady. Indicate that somehow on their quotes.
...
% XXX Replace this with compound constitutional republic
...
\end{frame}
% Include stuff about Utah's enabling act somewhere. Also pencil drawings, but make the Octopus have "State" on each arm
...
% XXX Get this back in somewhere.
