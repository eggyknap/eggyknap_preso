...
%     \begin{columns}[onlytextwidth]
%         \column{0.5\textwidth}
%             \begin{varblock}[0.9\textwidth]{}\huge{\centering Centralized control by distant administrators \\}\end{varblock}
% 
%         \column{0.5\textwidth}
%             \begin{varblock}[0.9\textwidth]{}\huge{\centering Local control by the people and accessible representatives \\}\end{varblock}
%     \end{columns}
%     \textbf{\huge{ \color{red}
%         \Put(155,120){v.}
%     }}
...
%         {\large { \textbf { Roman Law } }} &
%         {\large { \textbf { Common Law } }} \\
%             \begin{itemize}
%                 \item All powerful central government
%                 \item National sovereignty
%                 \item Tax and control everything
...
%                 \item Higher Law
%                 \item Law of Nature
%                 \item Keep your promises
%                 \item Don't hit other people or take their stuff
%             \end{itemize}
%         \\
%     \end{tabular}
%     \end{table}
