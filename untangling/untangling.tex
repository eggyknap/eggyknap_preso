...
\begin{frame}{Two Contending Forces}
    \begin{columns}[onlytextwidth]
        \column{0.5\textwidth}
            \begin{varblock}[0.95\textwidth]{}\huge{We the people of the United States is a nationalist system}\end{varblock}

        \column{0.5\textwidth}
            \begin{varblock}[0.95\textwidth]{}\huge{We the people of the States of NH, MA, RI, NY, PA, NJ, \ldots  are a federative system.}\end{varblock}
    \end{columns}
\end{frame}
