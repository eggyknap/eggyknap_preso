...
\begin{frame}{NoSQL?}
    ...
    \begin{itemize}
        ...
        transactions, but are using them incorrectly
    \end{itemize}
\end{frame}

\begin{frame}{More examples}
    You're not a bank. That doesn't mean you don't need transactions.
\end{frame}
...
\begin{frame}{Isolation levels}
    ...
    Stricter levels will possible entail poorer performance.
\end{frame}
